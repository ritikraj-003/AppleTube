...
export const CONFIG = {
  ...
  // ─── Remote Backend URL ──────────────────────────────────────────────────────
  // When running locally: leave as '' (relative URLs work via server.py)
  // After deploying server.py to Render/Railway: set this to your deployed URL
  // e.g. 'https://appletube-api.onrender.com'
  API_BASE_URL: '',
